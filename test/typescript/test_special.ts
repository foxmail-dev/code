 ...
 */
async function nullishCoalescingAwait(value: number | null | undefined): Promise<number> {
 ...
 * 特殊测试 17: 异步工厂模式
 */
async function asyncFactory(type: string): Promise<{ type: string; created: boolean }> {
