...
**工具**: 基于 `babel-plugin-transform-async-to-promises` 逆向 / 自定义 JavaScript Compiler API 脚本

**核心思路**:

使用 JavaScript Compiler API 解析 JS -> AST -> 转换 -> 打印
